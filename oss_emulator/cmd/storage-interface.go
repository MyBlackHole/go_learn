...
type StorageAPI interface {
	...
	ReadFile(ctx context.Context, volume, path string, offset int64, buffer []byte, w io.Writer) (int64, error)
    ...
    DeleteFile(ctx context.Context, volume, path string, fi FileInfo) (err error)
