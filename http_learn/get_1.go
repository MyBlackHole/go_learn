...
func login(name string, pass string, ukey string) (statusCode int, err error) {
	params := url.Values{}
	Url, err := url.Parse("https://q60py.91rong.com.cn:38010/ProxyConfigUkey/main/SelectInfo")
	if err != nil {
		return
	}
	pass = getMd5(pass)
...
func main() {
	//ret := getMd5("Urun15#%@asd")
	//fmt.Println(ret)

	//statusCode, err := login("jstest", "Urun15#%@asd", "99C4DDC1CBC72E4E5D48F63ECEA62C6")
	//if err != nil {
	//	return
	//}
